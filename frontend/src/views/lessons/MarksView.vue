...
<div v-if="marks">
  ...
  <section class="w-100 p-4 justify-content-center">
      ...
      <div class="row text-center" id="filter-sort-example-data">
          <div class="col-md-4 mt-3" v-for="mark in marks" :key="mark">
            <div class="card shadow-2">
<!--              <img src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/15.webp" class="card-img-top" alt="...">-->

              <div class="card-body">
                <h5 class="card-title">{{ mark.lesson.science }}</h5>
                <p class="card-text">
                  {{ mark.mark }}
                </p>
